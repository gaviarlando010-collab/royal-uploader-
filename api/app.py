...
# ========== TEMPLATE HTML (LANGSUNG DI-RENDER) ==========
HTML_TEMPLATE = '''
<!DOCTYPE html>
<html lang="id">
<head>
...
def upload_to_roblox():
    try:
        ...
        headers = {
            ...
            'User-Agent': 'Mozilla/5.0 (compatible; RoyalUploader)'
        }
        ...
        if asset_id:
            ...
            # Coba cek status
            if upload_resp.status_code in [200, 302]:
